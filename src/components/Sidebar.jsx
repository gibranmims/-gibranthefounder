...
import { CalendarDays, KanbanSquare, Lightbulb, Compass, Flame, Send, Target, Settings as SettingsIcon } from 'lucide-react'
...
const NAV_GROUPS = [
  { label: 'Daily',     items: [{ id: 'calendar', label: 'Calendar', Icon: CalendarDays }, { id: 'challenge', label: '100 Days', Icon: Target }] },
